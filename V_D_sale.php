...
<div class="center"> <!--aligning the body to the center of the page-->
  ...
  Date:  <input type="text" name="day_D" maxlength="2" size="2"> / <!--creating inputs for search by date-->
  <input type="text" name="month_D" maxlength="5" size="2"> /
  <input type="text" name="year_D" maxlength="4" size="4">
  <input type="submit" name="submit_D" value="Search" style="margin-right:70px;">
<?php
...
if (isset($_POST['submit_D']))
{
  ...
  <tr>
    ...
    <td>{$row['year']}</td>
      ...
      else {    echo "<br><br>Query didn't return any result";  //else condition if the query didn't return any result
        }
}
